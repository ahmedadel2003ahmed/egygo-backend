...
import { authLimiter, otpLimiter } from '../middlewares/rateLimiterMiddleware.js';
import {
 ...
 */
// Public routes
router.post('/register', authLimiter, validate(validateRegistration), authController.register);
